...
#get unnique list of year
plotYears = plotData["year"].unique()

#plot
chart = sns.lineplot(data=plotData, x="year", y="average_monthly_electricity_consumption_kwh", hue="planning_area")
chart.set_xticks(plotYears)
